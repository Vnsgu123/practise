...
def path_planning(graph, start, end):
    ...
    ** Note: You can use any path planning algorithm for this but need to produce the path in the form of 
    ...
    if o == 1 or o == 0:
        ...
        rr1 = path_planning_new_3(graph, start, end, backtrace_path)
        print("rrr and rr1 opppppp",rrr,rr1)
        wq=rrr
        if rr1 < rrr:
            wq = rr1
...
def path_planning_new_3(graph, start, end, backtrace_path):
    backtrace_path = []
    backtrace_path_1 = []
    backtrace_path_2 = []
    backtrace_path_3 = []
    ...
    for i in graph[k]:
        ...
        if u == 0:
            backtrace_path_1 = path_new_1(graph,i,end,backtrace_path)
            len1=len(backtrace_path_1)
            backtrace_path=[]
            #print('back and len1',backtrace_path_1,len1)
        if u == 1:
            backtrace_path_2 = path_new_1(graph,i,end,backtrace_path)
            len2=len(backtrace_path_2)
            backtrace_path=[]
            #print('back and len2',backtrace_path_2,len1)

        if u == 2:
            backtrace_path_3 = path_new_1(graph,i,end,backtrace_path)
            len3=len(backtrace_path_3)
            backtrace_path=[]
            #print('back and len3',backtrace_path_3,len1)
        if u == 3:
            backtrace_path_4 = path_new_1(graph,i,end,backtrace_path)
    ...
    if ky == len1:
        #print('u==',u)
        #print('return1-------------------------------------------------------------------------------------------------------------------------------------------------------- ',backtrace_path)
        #backtrace_path_1.insert(0,k)
        return backtrace_path_1
    if ky == len2:
        #print('u==',u)

        #print('return2 --------------------------------------------------------------------------------------------------------------------------------------------------',backtrace_path_2)
        #backtrace_path_2.insert(0,k)
        return backtrace_path_2
    if ky == len3:
        #print('u==',u)

        #print('return3 -----------------------------------------------------------------------------------------------------------------------------------------------',backtrace_path_3)
        #backtrace_path_3.insert(0,k)
        return backtrace_path_3
    if ky == len4:
        #print('u==',u)

        #print('return4 -----------------------------------------------------------------------------------------------------------------------------------------------',backtrace_path_4)
        #backtrace_path_4.insert(0,k)
        return backtrace_path_3

def path_new_1(graph,start,end,backtrace_path):
    ...
    if flag1==1:
        ...
        # kk=list[0]
        if k == d11:
            #backtrace_path.append(k1)
            backtrace_path_1=path_new_1(graph,k1,end,backtrace_path)
            # backtrace_path_1.insert(0, start)
            
            # print('len1 == and k ',backtrace_path_1)
            return backtrace_path_1
        if k == d12:
            #backtrace_path.append(k2)

            backtrace_path_2=path_new_1(graph,k2,end,backtrace_path)            
            # backtrace_path_2.insert(0, start)
            # print('len2 == and k ',backtrace_path_2)
            return backtrace_path_2
        if k == d13:
            # backtrace_path.append(k3)

            backtrace_path_3=path_new_1(graph,k3,end,backtrace_path)
...
####################### ADD YOUR CODE HERE #########################
    ...
    while l:
        ...
        if ic == 'Green_Circle':
            objectHandle = sim.loadModel(
                r'C:/Users/DICT/Desktop/PB Task 4A/PB Task 4A/package_models/Green_cylinder11.ttm')
            print('success 2')

        if ic == 'Green_Square':
            objectHandle = sim.loadModel(
                r'C:/Users/DICT/Desktop/PB Task 4A/PB Task 4A/package_models/Green_cube111.ttm')
            print('success 3')
        ...
        if ic == 'Pink_Circle':
            objectHandle = sim.loadModel(
                r'C:/Users/DICT/Desktop/PB Task 4A/PB Task 4A/package_models/Pink_cylinder11.ttm')
        if ic == 'Pink_Square':
            objectHandle = sim.loadModel(
                r'C:/Users/DICT/Desktop/PB Task 4A/PB Task 4A/package_models/Pink_cube11.ttm')
        if ic == 'Orange_Triangle':
            objectHandle = sim.loadModel(
                r'C:/Users/DICT/Desktop/PB Task 4A/PB Task 4A/package_models/Orange_cone.ttm')
        if ic == 'Orange_Circle':
            objectHandle = sim.loadModel(
                r'C:/Users/DICT/Desktop/PB Task 4A/PB Task 4A/package_models/Orange_cylinder11.ttm')
        if ic == 'Orange_Square':
            objectHandle = sim.loadModel(
                r'C:/Users/DICT/Desktop/PB Task 4A/PB Task 4A/package_models/Orange_cube111.ttm')
        if ic == 'Skyblue_Triangle':
            objectHandle = sim.loadModel(
                r'C:/Users/DICT/Desktop/PB Task 4A/PB Task 4A/package_models/Skyblue_cone.ttm')
        if ic == 'Skyblue_Circle':
            objectHandle = sim.loadModel(
                r'C:/Users/DICT/Desktop/PB Task 4A/PB Task 4A/package_models/Skyblue_cylinder11.ttm')
        if ic == 'Skyblue_Square':
            objectHandle = sim.loadModel(
                r'C:/Users/DICT/Desktop/PB Task 4A/PB Task 4A/package_models/Skyblue_cube11.ttm')
        keepInPlace = True
...
#################################  ADD YOUR CODE HERE  ###############################
    ...
    if len(scene_parameters) > 0:
        ...
        print('scene parameters  ',scene_parameters[1])
        u=scene_parameters[1]
        # if u > 0:
        #     u=u - 0.0610
        # if u < 0:
        #     u=u + 0.0610
